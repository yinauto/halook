wgp.DataNodeRectangle = Backbone.View.extend({
    ...
    render:function(){
    	...
    	this.element.object.mouseover(function (){
    		$("#nodeStatusBox").html("host name:"+self.host+"<br>capacity:"+self.capacity+"<br>usage:"+usage+"%");
    		$("#nodeStatusBox").css("display","block");
    		$("#nodeStatusBox").css("top",parseInt(this.attrs.path[0][2])+20);
    		$("#nodeStatusBox").css("left",parseInt(this.attrs.path[0][1]));
